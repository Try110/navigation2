...
class MyNode(Node):
    def __init__(self):
        super().__init__('sim_localization_22')
        self.tf_broadcaster = TransformBroadcaster(self)
        self.timer = self.create_timer(0.02, lambda: self.publish_tf('base_link', 'robotic_arm_center'))  # 50Hz (1/50 = 0.02s)
    ...
    def publish_tf(self, frame_id: str = 'map', child_frame_id: str = 'odom'):
        ...
        t.transform.translation.x = random.uniform(1, 1.6)
